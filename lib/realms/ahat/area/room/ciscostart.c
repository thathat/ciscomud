...
static void create() {
    ...
    SetLong("This is room 229, the CISCO lab. It's a busy looking room, cluttered and disorganized. The long 
trestle tables are covered with computers and cables, switches and routers, coffee cups, books, 
and the other detritus of learning. On the far end of the room stands a rack of switches, their 
lights blinking lazily.

An instructor's podium butts against one table. A donut box sits, half-open, on another table. A 
...
"default" : "You hear the hum and whirr of many computers.",
    ...
    SetExits(([
        "south" : "/realms/ahat/area/room/sample_room",
      ]));
