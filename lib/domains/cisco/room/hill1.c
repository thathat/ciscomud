...
static void create() {
    ...
    SetNightLight(20);
    SetDayLight(30);
    SetShort("%^B_BLACK%^%^WHITE%^ Top of the Hill %^RESET%^");
...
");
SetItems(([
({ "clouds", "cloud", "cumulonimbus" }) : "Look, an elephant! No, now it's a giraffe. Oh my, a MPLS cloud! Now it's the Internet!",
...
SetExits( ([
"north" : "/domains/cisco/room/serverroom",
"east" : "/domains/cisco/room/hilleast1",
"southeast" : "/domains/cisco/room/hillse1",
"west" : "/domains/cisco/room/hillwest1",
"southwest" : "/domains/cisco/room/hillsw1.c",
]) );
SetListen(([
...
SetDoor("north", "/domains/cisco/doors/hilldoor.c");
