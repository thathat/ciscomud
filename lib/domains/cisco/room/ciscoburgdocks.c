...
static void create() {
    ...
    SetNightLight(20);
    SetDayLight(30);
    SetShort("%^B_BLACK%^%^WHITE%^ The Docks %^RESET%^");
    SetLong(".");

    SetNightLong("Here, on the other end of the little stone bridge, a number of jaunty jetties jut out into the shallow waters of the brook. Cockleshell boats and coracles bob here and there, attached to the jetties with rope. At this time of night, the docks are empty of people, and the only sound is the gentle lap of brook water against the wood and shore.
    
Behind you, to the east, a little stone bridge leads across the brook. 
    ");
    SetDayLong("Here, on the other end of the little stone bridge, a number of jaunty jetties jut out into the shallow waters of the brook. Cockleshell boats and coracles bob here and there, attached to the jetties with rope. A handful of sailors and merchants hustle around, carrying supplies to and fro. Several bored-looking fishermen occupy the ends of the docks, watching their lines, or dozing.
...
({ "people", "fishermen" }) : "These well-tanned, weathered individuals look very relaxed. Some are nodding off at their post, while others read books, check their phones, or carry on long, philosophical conversations with their neighbors.",
({ "conversation", "conversations" }) : ".",
]));
SetExits( ([
"east" : "/domains/cisco/room/bridgesw1",
"north" : "/domains/cisco/room/ciscoburghomessouth.c",
]) );
